						...
						<div class="content-post-cart">
							...
							{{Form::open(array('method' => 'POST', 'id'=>'txtFormPaymentCart', 'class'=>'txtFormPaymentCart', 'name'=>'txtFormPaymentCart'))}}
								<div class="form-group">
									...
									<input id="txtMobile" name="txtMobile" class="form-control" maxlength="255" type="text" value="@if(isset($user_customer['customer_phone'])){{$user_customer['customer_phone']}}@endif">
								</div>
								<div class="form-group">
									<label>Họ và tên<span>(*)</span></label>
									<input id="txtName" class="form-control" name="txtName" maxlength="255" type="text" value="@if(isset($user_customer['customer_name'])){{$user_customer['customer_name']}}@endif">
								</div>
								<div class="form-group">
									<label class="control-label">Email</label>
									<input id="txtEmail" name="txtEmail" class="form-control" maxlength="255" type="text" value="@if(isset($user_customer['customer_email'])){{$user_customer['customer_email']}}@endif">
								</div>
								<div class="form-group">
									<label class="control-label">Địa chỉ<span>(*)</span></label>
									<input id="txtAddress" name="txtAddress" class="form-control" maxlength="255" type="text" value="@if(isset($user_customer['customer_address'])){{$user_customer['customer_address']}}@endif">
								</div>
								<div class="form-group">
									<label>Ghi chú</label>
