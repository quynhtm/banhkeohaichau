		...
		<div class="col-lg-8 col-md-8 col-sm-12 content-post-line">
			...
			<div class="list-item-post">
				...
				<div class="same-content-news">
					<div class="same-title">Thư viện video khác</div>
					@if(isset($dataSame) && sizeof($dataSame) > 0)
						<div class="row list-item-post">
							@foreach($dataSame as $k=>$item)
								<div class="col-lg-6 col-sm-6 item-video">
									<a title="{{stripslashes($item->video_title)}}" href="{{FunctionLib::buildLinkDetailVideo($item->video_name, $item->video_id)}}">
										<div>
                                            <?php
                                            $_video = str_replace('https://www.youtube.com/watch?v=', 'https://www.youtube.com/embed/', $item->video_link);
